...
--		luacheck: globals onDesktopInit onDesktopClose onModuleAdded onModuleUpdated
--		luacheck: globals customOnDesktopInit customOnDesktopClose  customOnModuleAdded customOnModuleUpdated
--		luacheck: globals powerUpMan getPowerUp setPowerUp registerExtension getExtensions versionChangeNotification
--		luacheck: purgeOldData setupData versionMessages saveExtensionData forceLoad forceLoadModule
...
function onInit()
	...
	OptionsManager.registerOption2(
					'PU_AUTO_RUN', false, 'option_PowerUp', 'option_label_PU_AUTO_RUN', 'option_entry_cycler',
					{ labels = 'option_val_on', values = 'enabled', baselabel = 'option_val_off', baseval = 'disabled', default = 'disabled' }
	);
	OptionsManager.registerOption2(
		'PU_NO_EXTA', false, 'option_PowerUp', 'option_label_PU_NO_EXTRA', 'option_entry_cycler',
		{ labels = 'option_val_on', values = 'enabled', baselabel = 'option_val_off', baseval = 'disabled', default = 'disabled' }
	);
	OptionsManager.registerOption2(
					'PU_FORCE_LOAD', false, 'option_PowerUp', 'option_label_PU_FORCE_LOAD', 'option_entry_cycler',
					{ labels = 'option_val_on', values = 'enabled', baselabel = 'option_val_off', baseval = 'disabled', default = 'disabled' }
	);
	...
	if Session.IsHost then
		...
		moduleUpdated = Module.onModuleUpdated;
